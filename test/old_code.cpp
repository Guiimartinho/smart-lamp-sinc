...
#define BUTTON_PIN D3 // Wemos D1 Mini D0
#define DATA_PIN D4   // Wemos D1 Mini D5
...
void setup_wifi()
{
  ...
  // Verifica qual rede WiFi está conectada
  if (WiFi.SSID() == WIFI_SSID_1)
  {
    Serial.println(WIFI_SSID_1);
  }
  else if (WiFi.SSID() == WIFI_SSID_2)
  {
